...
class RadialGauge extends StatelessWidget {
  ...
  const RadialGauge({Key? key, required this.weatherDataCurrent})
      : super(key: key);
...
class _RadialGauge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // return SFRadialGauge(weatherDataCurrent: weatherDataCurrent);
        ...
        child: Column(
          children: [
            ...
            Container(
                height: 150,
                width: 180,
                child: SFRadialGauge(weatherDataCurrent: weatherDataCurrent))
          ],
        ),
      ),
    );
